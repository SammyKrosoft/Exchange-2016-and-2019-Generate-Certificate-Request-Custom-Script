...
This script is simply a wrapper for the ```New-ExchangeCertificate``` cmdlet, which is used to generate the Certificate Security Request (CSR) that you will send to your CA to get a certificate for your Exchange servers. I just populates the variables for the following command line:
